...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a role="button" href="<?= helper::url("admin/menu/create") ?>" class="btn btn-sm btn-success">create</a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <a role="button" class="btn btn-sm btn-primary text-white"
                           href="<?= helper::url("admin/menu/edit/$menu->id") ?>">edit</a>
                        <a role="button" class="btn btn-sm btn-danger text-white"
                           href="<?= helper::url("admin/menu/delete/$menu->id") ?>">delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
